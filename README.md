...
<a href="#screenshots"><img src="./apps/busabase/public/assets/readme/busabase-hero.webp" alt="Busabase — review AI-proposed changes before they become trusted data" width="100%" /></a>
...
![How Busabase works: propose → change request → review → merge → trusted database & knowledge base, with a revise loop and reject path](./apps/busabase/public/assets/readme/how-it-works.webp)
...
|  |  |
| :---: | :---: |
| ![Inbox review list](./apps/busabase/public/assets/readme/busabase-inbox-review.webp) | ![Agent-proposed diff](./apps/busabase/public/assets/readme/busabase-agent-output-preview.webp) |
...
| ![Record detail lineage](./apps/busabase/public/assets/readme/busabase-record-detail-audit.webp) | ![Base table](./apps/busabase/public/assets/readme/busabase-base-table.webp) |
...
<p align="center">
  <img src="./apps/busabase/public/assets/readme/mobile-inbox-framed.webp" alt="Mobile inbox — pending Change Requests from agents" width="30%" />
  &nbsp;&nbsp;
  <img src="./apps/busabase/public/assets/readme/mobile-change-request-framed.webp" alt="Mobile Change Request — agent-proposed operations and fields under review" width="30%" />
  &nbsp;&nbsp;
  <img src="./apps/busabase/public/assets/readme/mobile-record-framed.webp" alt="Mobile record detail — trusted fields after approval" width="30%" />
</p>
...
**[Node Types](./apps/busabase/docs/node-types.md)** for screenshots and details.
...
| --- | --- |
| **[Blog CMS for Next.js](./apps/busabase/docs/use-cases.md#blog-cms-for-nextjs)** | AI-drafted posts, reviewed before they publish |
| **[SEO Landing Pages](./apps/busabase/docs/use-cases.md#seo-landing-pages)** | AI-generated landing pages, approved before they go live |
| **[Configuration Management](./apps/busabase/docs/use-cases.md#configuration-management)** | Service YAML/JSON reviewed before it ships |
| **[Finance & Invoice Review](./apps/busabase/docs/use-cases.md#finance-and-invoice-review)** | Automated finance entries a human signs off |
| **[Data Stewardship & CRM Hygiene](./apps/busabase/docs/use-cases.md#data-stewardship-and-crm-hygiene)** | A review queue that keeps business data clean |
| **[Compliance & Audit Checklists](./apps/busabase/docs/use-cases.md#compliance-and-audit-checklists)** | Recurring checks with evidence and an audit trail |
| **[QA & Training Datasets](./apps/busabase/docs/use-cases.md#high-quality-qa-and-training-datasets)** | Curated, approved examples for training / eval / RAG |
| **[Multimodal Content Review](./apps/busabase/docs/use-cases.md#multimodal-content-review)** | Image / audio / video metadata reviewed first |
| **[Market Intelligence](./apps/busabase/docs/use-cases.md#market-intelligence-and-research-monitoring)** | A human-reviewed research & monitoring feed |
| **[Content Factory Pipeline](./apps/busabase/docs/use-cases.md#content-factory-pipeline)** | Idea → draft → approved asset, end to end |
| **[Dataset Labeling Pipeline](./apps/busabase/docs/use-cases.md#dataset-labeling-pipeline)** | Agent-first labeling with human review |
| **[Project Management & ERP](./apps/busabase/docs/use-cases.md#approval-based-project-management-and-erp)** | Operational data changes behind an approval gate |
| **[Canonical System of Record](./apps/busabase/docs/use-cases.md#canonical-system-of-record)** | The single source of approved, canonical data |
| **[Local Personal Knowledge Base](./apps/busabase/docs/use-cases.md#local-personal-knowledge-base)** | A private, audited database for you and your AI tools |
| **[Verified Routine Work](./apps/busabase/docs/use-cases.md#verified-routine-work)** | Recurring work that's done, reviewed, and recorded |
| **[Field Type Lab](./apps/busabase/docs/use-cases.md#field-type-lab)** | Every field type and review op in one local scenario |

**[→ See all 16 use cases, with screenshots](./apps/busabase/docs/use-cases.md)**
...
**→ Step-by-step:** [Bring Your Own Agent](./apps/busabase/docs/bring-your-agent.md) — paste one prompt to onboard, then `npx skills add busabase/skills` to install a permanent skill your agent uses every session.
