...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./apps/busabase/public/logomark-dark.svg" />
  <img src="./apps/busabase/public/logomark.svg" alt="Busabase" width="96" height="96" />
</picture>
...
|  |  |
| :---: | :---: |
| ![Inbox review list](./apps/busabase/public/assets/readme/busabase-inbox-review.png) | ![Agent-proposed diff](./apps/busabase/public/assets/readme/busabase-agent-output-preview.png) |
...
| ![Record detail lineage](./apps/busabase/public/assets/readme/busabase-record-detail-audit.png) | ![Base table](./apps/busabase/public/assets/readme/busabase-base-table.png) |
...
| --- | --- |
| ![Blog Posts base with title, slug, status, tags, and publish date fields](./apps/busabase/public/assets/readme/scenarios/blog-cms-base.png) | ![Agent or writer submits a Markdown post as a Change Request](./apps/busabase/public/assets/readme/scenarios/blog-cms-inbox.png) |
...
| ![Reviewer checks body, metadata, links, and HTML preview](./apps/busabase/public/assets/readme/scenarios/blog-cms-review.png) | ![Approved post appears as a trusted record for the Next.js app](./apps/busabase/public/assets/readme/scenarios/blog-cms-record.png) |
...
| :---: | :---: |
| ![SEO Pages base with slug, title, meta description, target keywords, and HTML body fields](./apps/busabase/public/assets/readme/scenarios/seo-pages-base.png) | ![Agent proposes a complete HTML landing page as a Change Request](./apps/busabase/public/assets/readme/scenarios/seo-pages-inbox.png) |
...
| ![Reviewer checks HTML quality, copy, meta tags, and keyword targeting](./apps/busabase/public/assets/readme/scenarios/seo-pages-review.png) | ![Approved page record — Next.js reads the html field and renders a live landing page](./apps/busabase/public/assets/readme/scenarios/seo-pages-record.png) |
...
| :---: | :---: |
| ![Services base showing YAML and JSON code fields with syntax highlighting](./apps/busabase/public/assets/readme/scenarios/config-mgmt-base.png) | ![config-agent proposes a rate limit increase as a Change Request](./apps/busabase/public/assets/readme/scenarios/config-mgmt-inbox.png) |
| Services base with YAML and JSON code fields | config-agent proposes a rate limit increase |
| ![Reviewer sees the exact YAML diff with syntax highlighting](./apps/busabase/public/assets/readme/scenarios/config-mgmt-review.png) | ![api-gateway record with highlighted config field](./apps/busabase/public/assets/readme/scenarios/config-mgmt-record.png) |
...
| --- | --- |
| ![Invoices, orders, receipts, payments, or vendor records in a finance base](./apps/busabase/public/assets/readme/scenarios/finance-review-base.png) | ![Agent proposes invoice matching, expense categorization, or renewal cleanup](./apps/busabase/public/assets/readme/scenarios/finance-review-inbox.png) |
...
| ![Finance reviewer checks mismatches, suspicious rows, and explanation notes](./apps/busabase/public/assets/readme/scenarios/finance-review-review.png) | ![Approved reconciliation record with review and audit trail](./apps/busabase/public/assets/readme/scenarios/finance-review-record.png) |
...
| --- | --- |
| ![Company or contact records with stale, duplicate, or incomplete fields](./apps/busabase/public/assets/readme/scenarios/crm-hygiene-base.png) | ![Agent proposes dedupe, enrichment, lifecycle updates, or tag normalization](./apps/busabase/public/assets/readme/scenarios/crm-hygiene-inbox.png) |
...
| ![Data steward reviews field-level differences before merge](./apps/busabase/public/assets/readme/scenarios/crm-hygiene-review.png) | ![Clean approved CRM record with audit history](./apps/busabase/public/assets/readme/scenarios/crm-hygiene-record.png) |
...
| --- | --- |
| ![Access review, vendor compliance, policy, retention, or exception checklist records](./apps/busabase/public/assets/readme/scenarios/compliance-checklists-base.png) | ![Agent proposes evidence, status, owner, or due-date updates](./apps/busabase/public/assets/readme/scenarios/compliance-checklists-inbox.png) |
...
| ![Reviewer validates evidence before approving the checklist item](./apps/busabase/public/assets/readme/scenarios/compliance-checklists-review.png) | ![Approved compliance record with immutable audit events](./apps/busabase/public/assets/readme/scenarios/compliance-checklists-record.png) |
...
| --- | --- |
| ![QA examples table with question, answer, source, difficulty, and quality score](./apps/busabase/public/assets/readme/scenarios/training-datasets-base.png) | ![Agent proposes labels, explanations, or corrected answers as a Change Request](./apps/busabase/public/assets/readme/scenarios/training-datasets-inbox.png) |
...
| ![Reviewer scores quality and requests revisions when needed](./apps/busabase/public/assets/readme/scenarios/training-datasets-review.png) | ![Approved examples show review history for training or evaluation export](./apps/busabase/public/assets/readme/scenarios/training-datasets-record.png) |
...
| --- | --- |
| ![Video Clips base with transcript, scene description, detected objects, and usage rights](./apps/busabase/public/assets/readme/scenarios/multimodal-review-base.png) | ![Agent proposes tags, captions, scene labels, and rights metadata](./apps/busabase/public/assets/readme/scenarios/multimodal-review-inbox.png) |
...
| ![Reviewer inspects media fields and approves or rejects unsafe metadata](./apps/busabase/public/assets/readme/scenarios/multimodal-review-review.png) | ![Approved clip record is ready for media library, search, or dataset use](./apps/busabase/public/assets/readme/scenarios/multimodal-review-record.png) |
...
| --- | --- |
| ![Market intelligence base with sources, topics, competitors, and importance](./apps/busabase/public/assets/readme/scenarios/market-research-base.png) | ![Agent proposes summarized findings from monitored sources](./apps/busabase/public/assets/readme/scenarios/market-research-inbox.png) |
...
| ![Analyst reviews citations, relevance, and confidence before approval](./apps/busabase/public/assets/readme/scenarios/market-research-review.png) | ![Approved research record ready for reports, dashboards, or agent memory](./apps/busabase/public/assets/readme/scenarios/market-research-record.png) |
...
| --- | --- |
| ![Ideas, outlines, drafts, assets, SEO plans, and publishing tasks in one base](./apps/busabase/public/assets/readme/scenarios/content-factory-base.png) | ![Agent proposes a draft, title, metadata, or asset update](./apps/busabase/public/assets/readme/scenarios/content-factory-inbox.png) |
...
| ![Editor reviews content quality, SEO fields, and publishing readiness](./apps/busabase/public/assets/readme/scenarios/content-factory-review.png) | ![Approved publish-ready record with production history](./apps/busabase/public/assets/readme/scenarios/content-factory-record.png) |
...
| --- | --- |
| ![Dataset items awaiting captions, tags, scores, or benchmark answers](./apps/busabase/public/assets/readme/scenarios/dataset-labeling-base.png) | ![Agent proposes labels, explanations, classifications, or quality scores](./apps/busabase/public/assets/readme/scenarios/dataset-labeling-inbox.png) |
...
| ![Human reviewer corrects or approves labels before they enter the dataset](./apps/busabase/public/assets/readme/scenarios/dataset-labeling-review.png) | ![Approved labeled examples with review history for export](./apps/busabase/public/assets/readme/scenarios/dataset-labeling-record.png) |
...
| --- | --- |
| ![Projects, tasks, vendors, inventory, orders, or assets base as operational truth](./apps/busabase/public/assets/readme/scenarios/operations-erp-base.png) | ![Agent proposes status changes, reconciled fields, or missing operational data](./apps/busabase/public/assets/readme/scenarios/operations-erp-inbox.png) |
...
| ![Manager reviews the proposed Operations before they affect the source of truth](./apps/busabase/public/assets/readme/scenarios/operations-erp-review.png) | ![Approved operational record and downstream API-ready data](./apps/busabase/public/assets/readme/scenarios/operations-erp-record.png) |
...
| --- | --- |
| ![Base table with approved records as the source of truth](./apps/busabase/public/assets/readme/scenarios/canonical-base.png) | ![Change Requests from multiple writers before they become canonical](./apps/busabase/public/assets/readme/scenarios/canonical-inbox.png) |
...
| ![Reviewer compares proposed field changes before merge](./apps/busabase/public/assets/readme/scenarios/canonical-review.png) | ![Record lineage and audit trail after approval](./apps/busabase/public/assets/readme/scenarios/canonical-record.png) |
...
| --- | --- |
| ![Local notes, research, links, and files organized in a private base](./apps/busabase/public/assets/readme/scenarios/personal-knowledge-base.png) | ![Local agent proposes a new note or enrichment without direct write access](./apps/busabase/public/assets/readme/scenarios/personal-knowledge-inbox.png) |
...
| ![Human reviews the proposed private knowledge update on the local dashboard](./apps/busabase/public/assets/readme/scenarios/personal-knowledge-review.png) | ![Audit trail shows approved reads, writes, reviews, and merges](./apps/busabase/public/assets/readme/scenarios/personal-knowledge-record.png) |
...
| --- | --- |
| ![Daily or weekly review task records assigned to an agent or operator](./apps/busabase/public/assets/readme/scenarios/routine-work-base.png) | ![Agent submits completed work, classifications, or flagged issues as a proposal](./apps/busabase/public/assets/readme/scenarios/routine-work-inbox.png) |
...
| ![Reviewer approves, rejects, or asks for a revised result](./apps/busabase/public/assets/readme/scenarios/routine-work-review.png) | ![Trusted quality log with trigger or notification after merge](./apps/busabase/public/assets/readme/scenarios/routine-work-record.png) |
...
| --- | --- |
| ![Field Type Lab base with every supported field type](./apps/busabase/public/assets/readme/scenarios/field-types-base.png) | ![Agent proposes all-field coverage changes for review](./apps/busabase/public/assets/readme/scenarios/field-types-inbox.png) |
| Field Type Lab base with every supported field type | Agent proposes all-field coverage changes for review |
| ![Reviewer checks attachment, relation, AI, system, and scalar field diffs](./apps/busabase/public/assets/readme/scenarios/field-types-review.png) | ![Approved all-field record with review history](./apps/busabase/public/assets/readme/scenarios/field-types-record.png) |
