...
**[Claude Code guide](./apps/busabase/docs/claude-code.md)** explains the local skill and Cloud plugin. **[Bring Your Own Agent](./apps/busabase/docs/bring-your-agent.md)** covers the agent-neutral flow and permanent skill installation.
