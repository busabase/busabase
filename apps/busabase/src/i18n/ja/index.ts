...
const ja: Translation = {
  ...
  webhookSettings: {
    title: "Webhook",
    description:
      "このスペースで特定のイベントが発生したときに、Webhookの送信、エージェントへの通知、サンドボックス化されたコードスニペットの実行を自動的に行います。",
    openButton: "Webhook",
    addRule: "ルールを追加",
    ...
    actionKindRunSnippet: "コードスニペットを実行",
    ...
    snippetCodeLabel: "コード",
    snippetCodePlaceholder:
      "// `input` を確認し、呼び出す内容（url、method、headers、body）を返します",
    snippetHelperCaption:
      "このスニペットは `input`（イベントのペイロード）を受け取り、url、method、headers、bodyを含むオブジェクトを返すことで1回だけ外部呼び出しを行えます。それ以外の戻り値は記録されるだけです。ネットワークやファイルシステムへ直接アクセスすることはできません。",
    snippetTimeoutLabel: "タイムアウト（ミリ秒）",
    enabledLabel: "有効",
    cancel: "キャンセル",
    createRule: "ルールを作成",
    saveChanges: "変更を保存",
