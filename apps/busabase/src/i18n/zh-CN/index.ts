...
const zhCN: Translation = {
  ...
  userEnvSettings: {
    title: "环境变量",
    description: "为调用此 Busabase 实例的智能体和 API 工具保存运行时密钥。",
    openButton: "环境变量",
    nameLabel: "名称",
    valueLabel: "值",
    ...
    saveFailed: "保存环境变量失败",
    cleared: "环境变量已清空",
    storageTitle: "本地用户作用域",
    storageDescription: "这些值保存在本地 Busabase 数据库中，并注入给内置本地用户使用。",
    requestScopeTitle: "请求作用域",
    requestScopeDescription:
      "API、RPC 和 MCP 调用可以通过 Busabase 运行时读取这些值，不会写入 process.env。",
    noVariables: "还没有配置变量。",
  },
  marketing: {
