...
export declare const AgentConnectionVOSchema: z.ZodObject<
  {
    slug: z.ZodString;
    agentName: z.ZodString;
    transport: z.ZodEnum<{
...
export declare const AgentConnectionScopeSchema: z.ZodEnum<{
  mine: "mine";
  space: "space";
}>;
export type AgentConnectionScope = z.infer<typeof AgentConnectionScopeSchema>;
export declare const ListAgentConnectionsInputSchema: z.ZodObject<
  {
    scope: z.ZodDefault<
      z.ZodEnum<{
        mine: "mine";
