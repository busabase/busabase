...
export declare const countRecordsResponseSchema: z.ZodObject<
  ...
  z.core.$strip
>;
export declare const groupRecordsInputSchema: z.ZodObject<
  {
    baseId: z.ZodString;
    fieldSlug: z.ZodString;
    viewId: z.ZodOptional<z.ZodString>;
  ...
  z.core.$strip
>;
export declare const groupRecordsResponseSchema: z.ZodObject<
  {
    groups: z.ZodArray<
      z.ZodObject<
        {
...
export declare const createBulkChangeRequestInputSchema: z.ZodObject<
  ...
  z.core.$strip
>;
export declare const createBulkUpdateChangeRequestInputSchema: z.ZodObject<
  {
    updates: z.ZodArray<
      z.ZodObject<
        {
