...
export declare const baseContract: {
  ...
  createBulkChangeRequest: import("@orpc/contract").ContractProcedureBuilderWithInputOutput<
    ...
    Record<never, never>
  >;
  createBulkUpdateChangeRequest: import("@orpc/contract").ContractProcedureBuilderWithInputOutput<
    z.ZodObject<
      {
        updates: z.ZodArray<
          z.ZodObject<
...
export declare const recordContract: {
  ...
  count: import("@orpc/contract").ContractProcedureBuilderWithInputOutput<
    ...
    Record<never, never>
  >;
  groupBy: import("@orpc/contract").ContractProcedureBuilderWithInputOutput<
    z.ZodObject<
      {
        baseId: z.ZodString;
        fieldSlug: z.ZodString;
