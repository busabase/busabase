...
export declare const dumpContract: {
  ...
  exportAssetText: import("@orpc/contract").ContractProcedureBuilderWithInputOutput<
    ...
    Record<never, never>
  >;
  exportDocBodies: import("@orpc/contract").ContractProcedureBuilderWithInputOutput<
    import("zod").ZodObject<
      {
        nodeIds: import("zod").ZodArray<import("zod").ZodString>;
      },
      import("zod/v4/core").$strip
    >,
    import("zod").ZodObject<
      {
        bodies: import("zod").ZodArray<
          import("zod").ZodObject<
            {
    ...
    Record<never, never>
  >;
  importBegin: import("@orpc/contract").ContractProcedureBuilderWithInputOutput<
    import("zod").ZodObject<
      {
        sourceSpaceId: import("zod").ZodString;
        resume: import("zod").ZodDefault<import("zod").ZodOptional<import("zod").ZodBoolean>>;
      },
      import("zod/v4/core").$strip
    >,
    import("zod").ZodObject<
