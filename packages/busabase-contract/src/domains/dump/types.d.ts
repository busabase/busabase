 ...
 */
export declare const EXPORT_DOC_BODIES_MAX_BATCH = 25;
export declare const ExportDocBodiesInputSchema: z.ZodObject<
  {
...
export declare const ExportDocBodiesVOSchema: z.ZodObject<
  {
    bodies: z.ZodArray<
      z.ZodObject<
        {
...
export declare const ImportBeginInputSchema: z.ZodObject<
  {
