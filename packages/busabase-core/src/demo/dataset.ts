...
export const DEMO_RECORDS: SeedRecordDef[] = [
  ...
  {
    id: "rec_seed_field_type_lab_draft",
    baseId: DEMO_FIELD_TYPE_LAB_BASE_ID,
    commitId: "cmt_seed_field_type_lab_draft",
    fields: {
      ai_summary: "A queued draft record — earlier in the review lifecycle than the approved one.",
      ai_tags: ["draft", "queued", "seed"],
      attachment: [
        {
          id: "att_seed_field_lab_draft_notes",
          attachmentId: "att_seed_field_lab_draft_notes",
          fileName: "field-type-lab-draft-notes.md",
          mimeType: "text/markdown",
          size: 2_048,
          url: "/assets/readme/scenarios/multimodal-review-record.png",
        },
      ...
      code: 'export const reviewPolicy = {\n  requiredApprovals: 2,\n  allowSelfReview: false,\n  agents: ["draft-agent"],\n};',
      longtext:
        "A second long-text sample, shorter than the first, so the view shows visibly different row heights.",
      markdown: "## Draft\n\n- Not yet reviewed\n- Waiting in the queue",
      multiselect: ["text", "review"],
      number: 7,
      phone: "+1-555-0199",
      ...
      updated_by: "field-type-agent",
      updated_time: "2026-06-24T09:15:00.000Z",
      url: "https://busabase.local/field-type-lab/draft",
      embed: "https://drive.google.com/file/d/1a2b3c4d5e6f7g8h9i0j/view",
    },
    message: "Seed a queued draft field-type coverage record",
    author: "seed-qa",
    minutesAgo: 90,
    createdTimeSlug: "created_time",
    useCases: ["field-types"],
  ...
  {
    id: "rec_seed_field_type_lab_approved",
    baseId: DEMO_FIELD_TYPE_LAB_BASE_ID,
    commitId: "cmt_seed_field_type_lab_approved",
    fields: {
      ai_summary: "An approved record — the review lifecycle's terminal state, shown for contrast.",
      ai_tags: ["approved", "final", "seed"],
      attachment: [
        {
          id: "att_seed_field_lab_approved_png",
          attachmentId: "att_seed_field_lab_approved_png",
          fileName: "field-type-lab-approved.png",
          mimeType: "image/png",
          size: 98_304,
          url: "/assets/readme/scenarios/multimodal-review-base.png",
        },
      ...
      code_yaml:
        "model: gpt-5\ntemperature: 0.1\nmax_tokens: 4096\nstream: true\nretry:\n  attempts: 3\n  delay_ms: 1000",
      code: 'export const reviewPolicy = {\n  requiredApprovals: 1,\n  allowSelfReview: true,\n  agents: ["analysis-agent", "draft-agent"],\n};',
      longtext:
        "A third long-text sample, this one written to be the longest of the three so the view's scanning behavior can be checked against real length variance.",
      markdown: "## Approved\n\n- Reviewed and merged\n- Counted as a trusted record",
      multiselect: ["media", "review"],
      number: 99.99,
      phone: "+1-555-0177",
      ...
      updated_time: "2026-06-26T16:45:00.000Z",
      url: "https://busabase.local/field-type-lab/approved",
      embed: "https://www.youtube.com/watch?v=jNQXAC9IVRw",
    },
    message: "Seed an approved field-type coverage record",
    author: "seed-qa",
    minutesAgo: 60,
    createdTimeSlug: "created_time",
    useCases: ["field-types"],
