  ...
  // ── Operations ─────────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        slug: "owner",
        name: "Owner",
        // Was `text` holding a team mailbox. These Bases track work a PERSON is
        // accountable for, which is what the member field is for.
        type: "member",
        required: false,
  ...
  // ── Routine Work ───────────────────────────────────────────────────────────
  {
    ...
    fields: [
      ...
      },
      {
        ...
        slug: "assignee",
        name: "Assignee",
        // Was `text` holding a team mailbox. A todo is assigned to a PERSON —
        // this column is the workaround the member field replaces.
        type: "member",
        required: false,
        options: { multiple: false },
      },
