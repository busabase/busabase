                    ...
                    <div className="mt-auto flex flex-col gap-2 pt-1">
                      {entry.comingSoon ? (
                        ...
                        <div className="flex flex-col gap-2">
                                ...
                                >
                                  ...
                                  <Button
                                    ...
                                    onClick={() => {
                                      ...
                                      createSession.mutate({ slug: agent.slug });
                                    }}
                                    size="sm"
                                    variant="outline"
                                  >
                                    {pendingSlug === agent.slug
                                      ? messages.agents.starting
                                      : messages.agents.startSession}
                                  </Button>
                                </li>
                              ))}
                            </ul>
                          ...
                          <Button
                            className="min-h-11 sm:min-h-9"
                            onClick={openBudaConnect}
                            size="sm"
                          >
                            {entry.connectedAgents.length > 0
                              ? messages.agents.connectAnotherBuda
