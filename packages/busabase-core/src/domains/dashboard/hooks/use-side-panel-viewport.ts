 ...
 * `max-width: 1023.98px`, i.e. just under Tailwind's `lg`, so the panel flips
 * to "mobile" behavior at the same point the rest of the app's
 * workbench-style layouts do.
 */
