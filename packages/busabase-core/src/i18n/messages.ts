...
// so they stay compatible with the apps' ts7-i18n catalogs that import them,
...
export const coreMessagesEn = {
  ...
  nodeDetail: {
    ...
    uploadTasks: "Uploads",
    collapseUploadTasks: "Collapse uploads",
    expandUploadTasks: "Expand uploads",
    dismissUploadTask: "Dismiss upload",
    cancelUploadTask: "Cancel",
    retryUploadTask: "Retry",
    reviewUploadTask: "Review",
    uploadTaskQueued: "Waiting to upload",
    uploadTaskUploading: "Uploading files",
    uploadTaskSubmitting: "Creating change request",
    uploadTaskCompleted: "Upload complete",
    uploadTaskReviewReady: "Upload ready for review",
    uploadTaskFailed: "Upload failed",
    uploadTaskCancelled: "Upload cancelled",
    uploadTaskSubmissionUncertain:
      "Could not verify the change request. Check Inbox before trying again.",
    uploadTaskFileQueued: "Waiting",
    uploadTaskFileHashing: "Preparing",
    uploadTaskFileUploading: "Uploading",
    uploadTaskFileConfirming: "Confirming",
    uploadTaskFileCompleted: "Uploaded",
    uploadTaskFileFailed: "Failed",
    uploadTaskFileCancelled: "Cancelled",
    uploadTaskBatchProgress: "Batch upload {progress}% complete",
    ...
    openFileInNewTab: "Open in new tab",
  ...
  share: {
    ...
    expiryLabel: "Expires",
    expiryHint: "The link stops working automatically at the selected time.",
    expiryNever: "Never",
    expiryOneDay: "In 1 day",
    expirySevenDays: "In 7 days",
    expiryThirtyDays: "In 30 days",
    expiryCustom: "Custom date and time",
    apply: "Apply",
    ...
    settingsHint: "Control what visitors can do and when this link stops working.",
    loading: "Loading share settings…",
    loadFailed: "Share settings could not be loaded.",
    retry: "Retry",
    closeUncopiedEmbedConfirm: "This embed link is shown only once. Close without copying it?",
   ...
   *
   * Deliberately a TOP-LEVEL block rather than nested under `share`: the same
   * section is meant to be reusable outside the Share dialog (a Change Request
   * or a record detail can be embedded too), and nesting it under `share` would
   * imply it is governed by the share toggle. It is not — that is precisely the
   * confusion `notRevokedByShareToggle` exists to correct.
   */
  embedLinks: {
    title: "Embed on another site",
    hint: "Create a read-only link you can drop into an <iframe> on a page you control. It expires on its own, and you can revoke it at any time.",
    airappHint:
      "Anyone who opens the embed RUNS this AirApp: its files are sent to their browser, and it can read this workspace's other publicly shared nodes.",
    notRevokedByShareToggle:
      "Embed links keep working after “Share to web” is turned off — {count} is still live for this node. Revoke them below if you meant to cut off access.",
    createButton: "Create embed link",
    creating: "Creating…",
    ...
    expires8h: "8 hours",
    expires24h: "24 hours",
    frameLabel: "Where it may be embedded",
    frameAnywhere: "Any site",
    frameOrigins: "Only these sites",
    frameTopLevel: "Opened directly only",
    originsLabel: "Allowed sites",
    originsPlaceholder: "https://example.com",
    originsHint:
      "One site per line, up to {max}. HTTPS only, origin without a path (http://localhost is allowed for testing).",
    createdTitle: "Embed link created",
    createdOnceHint:
      "This is the only time the link is shown — Busabase stores only its hash. Copy it now.",
    createdCopiedHint: "Copied. This one-time link is safe to close now.",
    linkLabel: "Link",
    iframeLabel: "Embed code",
    copyLink: "Copy link",
    copyIframe: "Copy embed code",
    copied: "Copied",
    loading: "Loading embed links…",
    listTitle: "Active embed links",
    listEmptyTitle: "No embed links yet",
    listEmptyBody: "Links you or an agent create for this node show up here.",
    activeEmptyTitle: "No active embed links",
    activeEmptyBody: "Create one when you are ready to embed this node on another site.",
    ...
    revoke: "Revoke",
    revokeConfirmTitle: "Revoke this embed link?",
    revokeConfirmBody:
      "Every page that already embeds {target} stops seeing it on its next request. This can't be undone — create a new link instead.",
    revoked: "Embed link revoked",
    created: "Embed link created",
    failed: "Something went wrong",
  },
  embedLinkAudit: {
    title: "Embed links",
    description:
      "Review no-login embed links across this workspace and revoke access that should no longer be live.",
    oneTimeHint:
      "Existing link URLs cannot be shown again because Busabase stores only their secret hashes.",
    filterActive: "Active",
    filterExpired: "Expired",
    filterRevoked: "Revoked",
    filterAll: "All",
    loading: "Loading embed links…",
    failedTitle: "Couldn't load embed links",
    failedBody: "The audit is unavailable right now. Nothing has been reported as safely unshared.",
    retry: "Retry",
    emptyActiveTitle: "No active embed links",
    emptyActiveBody: "No no-login embed link is currently granting access in this workspace.",
    emptyHistoryTitle: "No links in this view",
    emptyHistoryBody: "Choose another status to inspect the workspace's embed-link history.",
    continueTitle: "More links may be available",
    continueBody:
      "This audit window contained no manageable targets. Continue to the next bounded window.",
    target: "Target",
    kind: "Kind",
    policy: "Allowed location",
    created: "Created",
    expires: "Expires",
    status: "Status",
    actions: "Actions",
    ...
    kindRecord: "Record",
    loadedCount: "{count} links loaded",
    loadMore: "Load more",
    loadingMore: "Loading…",
    revoke: "Revoke",
    revokeConfirmTitle: "Revoke this embed link?",
    revokeConfirmBody:
      "Every page using {target} stops receiving content on its next request. This cannot be undone.",
    revoked: "Embed link revoked",
    revokeFailed: "Couldn't revoke the embed link",
    permissionTitle: "Manage access required",
    permissionBody: "Only workspace owners and admins can audit or revoke embed links.",
  },
  airapp: {
  ...
  agents: {
    ...
    permissionTimeout: "Times out in {count}s if left unanswered.",
    permissionTimingOut: "Timing out…",
    ...
    toolStatusApprovalRequested: "Approval requested",
    toolStatusApprovalResponded: "Approval received",
    ...
    fileTooLarge: "That file is too large. The limit is {limit} MB.",
    tooManyFiles: "You can attach at most {count} files at a time.",
    attachmentFailed: "Couldn't attach the file.",
    title: "Agents",
    description: "Connect an external AI agent. Busabase has no AI engine of its own.",
    back: "Back",
    local: "Local",
    remote: "Remote",
    ...
    connectionDeleted: "Agent connection deleted.",
    connectionDeleteFailed: "Could not delete agent connection.",
    unavailableFallback: "This agent is currently unavailable.",
    loadConnectionsFailedTitle: "Couldn't load connected agents",
    loadCatalogFailedTitle: "Couldn't load the agent catalog",
    catalogClaudeDescription: "Anthropic's Claude, wrapped for ACP. Runs on this machine.",
    catalogCodexDescription: "OpenAI's Codex CLI, wrapped for ACP. Runs on this machine.",
    catalogBudaDescription:
      "A hosted Buda agent. Runs in Buda's cloud — nothing is installed locally.",
    unavailableOnCloud:
    ...
    missingLocalBinary: "{binary} was not found on this machine. Install Node.js to use {name}.",
    budaEnvRequired: "Set BUDA_API_KEY and BUDA_AGENT_ID to connect to Buda.",
    budaSignInRequired: "Sign in to Buda and choose an agent to connect.",
    deleteConnectionTitle: "Delete agent connection?",
    deleteConnectionBody:
      "Delete {name} and its {count} {unit}? This removes the saved connection and conversation history. This cannot be undone.",
    queryFallbackError: "Please try again.",
    queryRetry: "Retry",
    allowPopups: "Allow popups for Busabase, then try again.",
    budaConnectionFailed: "Buda connection failed.",
    budaIdentityMissing: "Buda connected without an agent identity. Try again.",
    comingSoon: "Coming soon",
    connectedTo: "Connected to {name}",
    integrationComingSoon: "This integration is coming soon.",
    startSession: "Start session",
    connectAnotherBuda: "Connect another Buda agent",
    signInBuda: "Sign in to Buda",
    connect: "Connect",
    codexInstallTitle: "Install Codex ACP?",
    codexInstallBody:
      "Busabase Desktop will download @agentclientprotocol/codex-acp@1.1.14 from the npm registry into its private app data. It uses the Node and npm included with Desktop. Codex CLI is installed and signed in separately.",
    codexInstallAction: "Install and connect",
    codexInstalling: "Installing Codex ACP…",
    codexInstallRetry: "Retry installation",
    codexCliMissing: "Codex CLI was not found. Install Codex CLI, then return and connect again.",
    codexLoginRequired: "Sign in to Codex CLI with `codex login`, then return and connect again.",
    codexInstallCancel: "Cancel",
    claudeInstallTitle: "Install Claude Code ACP?",
    claudeInstallBody:
      "Busabase Desktop will download @agentclientprotocol/claude-agent-acp@0.66.0 and the Claude Agent SDK native binary from the npm registry into its private app data. It uses the Node and npm included with Desktop. Sign in to Claude separately.",
    claudeInstalling: "Installing Claude Code ACP…",
    claudeLoginRequired:
      "Sign in to Claude Code in a terminal with `claude auth login`, then return and connect again.",
    connectBuda: "Connect Buda",
    budaConnectHint: "Sign in and choose the agent Busabase may chat with.",
    budaConnectDescription:
      "Buda opens in its own secure window so your Buda login cookie stays first-party. After you choose an agent, this dialog closes automatically and starts the ACP chat.",
    openBuda: "Open Buda",
    closeBudaDialog: "Close Buda connection dialog",
    starting: "Starting…",
    ...
    endSessionTitle: "End this conversation?",
    endSessionBody:
      "Stop {name} and release the process it is holding. This conversation stays here to read, and you can start a new session any time.",
    endSessionBusyBody:
      "{name} is replying right now — ending stops it mid-reply. This conversation stays here to read, and you can start a new session any time.",
    endSessionDone: "Session ended. The conversation is still here.",
    endSessionAlreadyEnded: "This session had already ended. The conversation is still here.",
    endSessionFailed: "Couldn't end this session.",
    catalogEmptyTitle: "No agents available",
    catalogEmptyBody: "The agent catalog returned no entries. Try reloading.",
    sessionCreateFailed: "Couldn't start this agent.",
    deleteHistoryTitle: "Delete conversation history?",
    deleteHistoryBody: "Permanently delete {count} {unit} with {name}? This cannot be undone.",
    deleteHistoryBodyEndsLocalSessions: " Active local sessions will end.",
    deleteHistoryBodyKeepsConnection: " The saved connection remains.",
    deleteHistoryDone: "Conversation history deleted.",
    deleteHistoryFailed: "Could not delete conversation history.",
  },
  templates: {
    title: "Templates",
    overview:
    ...
    browseOnly:
      "Browsing is open to everyone. Installing a template is a space owner or admin action — it can carry an app and a skill, which is code this space's agents will run.",
    ...
    install: "Install",
    installRestricted:
      "Space owners and admins only — a template can carry an app and a skill, which is code this space's agents will run.",
    ...
    screenshotGallery: "Template screenshots",
    screenshot: "Template screenshot {number}",
  },
  form: {
    alreadyExists:
    ...
    // Binding a Form to a Base from the UI — the empty state's recovery path and
    // the New-item dialog's "Writes into" picker share this copy.
    setUpCta: "Connect this form to a Base",
    setUpTitle: "Connect this form to a Base",
    setUpDescription:
      "Pick the Base this form writes into, then choose which of its fields it should collect.",
    setUpSubmit: "Save form",
    setUpSaving: "Saving…",
    setUpFailed: "Couldn't set up this form.",
    setUpNeedsManage:
      "Setting up a form needs admin access on the Base it writes into. Ask a workspace admin, or an agent.",
    targetBase: "Writes into",
    targetBaseHelp: "Every submission becomes a record-create change request on this Base.",
    targetBaseRequired: "Pick the Base this form writes into.",
    targetBasePlaceholder: "Choose a Base…",
    collectFields: "Fields to collect",
    collectFieldsRequired: "Pick at least one field for this form to collect.",
    noBases: "There are no Bases here yet. A form always writes into one, so create a Base first.",
    basesFailed: "Couldn't load the Bases in this workspace.",
    needsWorkspaceConnection: "Connect to a workspace to pick the Base this form writes into.",
    // "Forms writing into this Base" — provenance for the Base, not the form.
    forBaseTitle: "Forms writing into this Base",
    forBaseCount: "{count} form{plural}",
    forBaseEmpty: "No form writes into this Base.",
    forBaseSubmissions: "{count} submission{plural}",
    forBaseBoundFields: "{count} bound field{plural}",
    forBasePublicWarning: "Anyone with the link can submit into this Base.",
    forBaseLoadMore: "Load more",
    forBaseFailed: "Couldn't load the forms writing into this Base.",
  },
  sidePanel: {
    label: "Side panel",
    ...
    agentPickerBack: "Back",
    agentPickerLoading: "Loading connected agents…",
    agentPickerError: "Couldn't load connected agents.",
    agentPickerRetry: "Retry",
  ...
  searchPage: {
    ...
    patternInvalid: "That is not a valid regular expression yet.",
    patternMatchCount: "{count} matches",
    patternLineNumber: "{line}",
    patternExtractedText: "extracted text",
    patternCoverageComplete: "Everything in scope was read",
    patternCoverageIncomplete: "Some of this workspace was not read — see what was skipped",
    patternCoverageScanned: "{count} items scanned",
    patternCoverageNotReached: "{count} never opened — the scan budget ran out first",
    patternCoverageUnread: "{count} files had no readable text to scan",
    patternCoverageErrored: "{count} could not be read",
    loadMore: "Load more",
    loading: "Searching…",
  ...
  activity: {
    ...
    auditActions: {
      ...
      airappCreated: "AirApp created",
      assetDeleted: "Asset deleted",
      assetMetadataUpdated: "Asset metadata updated",
      assetTextWritten: "Asset text written",
      assetTextMarkedNone: "Asset text cleared",
      nodeMetadataUpdated: "Node metadata updated",
      nodeSettingsUpdated: "Node settings updated",
      nodeAgentPromptsUpdated: "Node agent prompts updated",
      nodePurged: "Node permanently deleted",
    },
    audit: "audit",
    commit: "commit",
    changeRequest: "change request",
  ...
  search: {
    ...
    continueAdvanced: "Continue in advanced search",
    quickSearchSlow: "This search needs more time",
    retry: "Try again",
    loadMore: "Load more",
    noMatchesTitle: "No matches",
  ...
  base: {
    ...
    noMembersAvailable: "No members to choose from",
    ...
    selectAllRecords: "Select all rows on this page",
    ...
    editSelectedRecords: "Edit selected",
    bulkEditTitle: "Edit the selected rows",
    bulkEditDescription:
      "Fields you leave alone stay exactly as they are on every selected record.",
    bulkEditPageScopeNote: "Applies to the {count} row{plural} selected on this page.",
    bulkEditLeaveUnchanged: "Leave unchanged",
    bulkEditSetTo: "Set {field} on every selected row",
    bulkEditSetToShort: "Set to",
    bulkEditNoFieldsChosen: "Pick at least one field to change.",
    updateRecordsNow: "Update {count} now",
    updatingRecordsNow: "Updating…",
    submitUpdateRecordsRequest: "Submit {count} row update{plural} for review",
    submittingUpdateRecordsRequest: "Submitting…",
    bulkUpdateResult: "{count} row{plural} updated",
    bulkUpdateRequestResult: "Row updates submitted for review",
    bulkEditHint:
      "All selected rows change together, in one review — if one row can't be applied, none are.",
    failedBulkEdit: "Failed to update the selected rows",
    importRecords: "Import rows",
    importStepMap: "Columns",
    importPasteLabel: "Paste rows",
    importPastePlaceholder: "Paste from a spreadsheet — the first line is the header row.",
    importPasteFormatNote:
      "Paste tab-separated rows copied from a spreadsheet. The first line is treated as the header. Quoted CSV is not parsed.",
    importMappedTo: "→ {field}",
    importSkipColumn: "→ no matching field, skipped",
    importUnsupportedColumn: "→ this column type can't be imported, skipped",
    importRowsParsed: "{count} row{plural} ready",
    importRowsInvalid: "Problems in {count} row{plural}",
    importRowError: "Row {row} · {field}: {message}",
    importDropInvalidRows: "Skip the rows with problems",
    importTooManyRows: "Import is capped at {max} rows — split the paste.",
    importNothingToImport: "None of these columns match a field in this table.",
    importNow: "Import {count} row{plural}",
    importing: "Importing…",
    submitImportRequest: "Submit {count} row{plural} for review",
    submittingImportRequest: "Submitting…",
    importMerged: "{count} row{plural} imported",
    importRequestSubmitted: "Import submitted for review",
    importHint:
      "All rows are created together, in one review — if one row can't be created, none are.",
    failedImportRecords: "Failed to import the pasted rows",
    commit: "Commit",
    ...
    viewFieldDragInstructions:
      "To pick up a field, press Space or Enter. While dragging, use the arrow keys to move it. Press Space or Enter again to drop, or Escape to cancel.",
    viewFieldDragStarted: "Picked up {name}. Position {position} of {count}.",
    viewFieldDragMoved: "{name} moved to position {position} of {count}.",
    viewFieldDragDropped: "{name} dropped at position {position} of {count}.",
    viewFieldDragCancelled: "Reordering cancelled. {name} returned to its original position.",
    viewFieldDragOutside: "The field is outside the reorder area. Drop to cancel.",
    ...
    fieldTypeChange: "Field type",
    fieldTypeChangeUnavailable:
      "This field's type can't be changed — its stored values have no text form.",
    conversionChoiceModeLegend: "Values with no matching option",
    conversionChoiceModeNullOnMissing: "Clear them",
    conversionChoiceModeNullOnMissingHint: "A value with no matching option is dropped.",
    conversionChoiceModeAutoCreate: "Create an option for each",
    conversionChoiceModeAutoCreateHint: "A new option is added for every value that needs one.",
    conversionPreviewTitle: "What happens to the stored values",
    conversionPreviewLoading: "Checking every value…",
    conversionPreviewFailed: "Couldn't check the stored values.",
    conversionConflicts: "{count} value{plural} will be cleared",
    conversionNoConflicts: "Every value survives this change.",
    conversionTotals: "{total} values · {convertible} convert · {nulls} already empty",
    conversionConflictSampleNote: "Showing {shown} of {count}.",
    conversionIrreversible: "Cleared values can't be recovered from the change request.",
    conversionHint: "Request goes to your inbox for review. Now converts immediately.",
    requestConvert: "Request type change",
    convertNow: "Change type now",
    converting: "Changing type…",
    fieldTypeChanged: "Field type changed",
    convertRequestSubmitted: "Type change submitted for review",
    convertFieldMessage: "Change {field} to {type}",
    failedConvertField: "Failed to change field type",
    deleteField: "Delete field",
    deleteFieldAria: "Delete {name}",
    deleteFieldCounting: "Counting affected records…",
    deleteFieldCountUnavailable: "Couldn't count the affected records.",
    deleteFieldImpact: "This column has a value in {count} record{plural}.",
    deleteFieldReversible:
      "The column and its values are kept and can be brought back from Deleted Fields.",
    deleteFieldHint: "Request goes to your inbox for review. Now deletes immediately.",
    requestDeleteField: "Request delete",
    deleteFieldNow: "Delete now",
    fieldDeleted: "Field deleted",
    deleteFieldRequestSubmitted: "Delete submitted for review",
    deleteFieldMessage: "Delete field {field}",
    failedDeleteField: "Failed to delete field",
  },
  review: {
    ...
    conversionCheckedNow:
      "Checked just now against the column's current values — nothing locks the column until this merges.",
  ...
  graph: {
    nodeInstructions: "Press Enter or Space to select a node. Press Delete to remove it.",
    nodeMovementInstructions:
      "Use the arrow keys to move the selected node. Press Escape to cancel.",
    nodeMoved: "Node moved {direction} to {x}, {y}",
    directions: { up: "up", down: "down", left: "left", right: "right" },
    edgeInstructions: "Press Enter or Space to select an edge. Press Delete to remove it.",
    miniMap: "Mini map",
  ...
  agentPrompts: {
    ...
    copyShort: "Copy",
    copied: "Copied",
    copyFailed: "Couldn't copy automatically — select the prompt preview and copy it manually.",
    askAgent: "Ask Agent",
    askAgentDirectly: "Ask Agent Directly",
    askAgentOptions: "Ask Agent options",
  ...
  assets: {
    ...
    metadataBadge: "meta",
    metadataEdit: "Edit",
    metadataEditTitle: "Edit metadata",
    metadataEditDescription:
      "These notes are what agents read to decide which file to open. Values keep their type — text stays text, numbers stay numbers.",
    metadataEmpty: "No metadata yet",
    metadataEmptyHint:
      "Add a summary, tags, or a source URL so agents can tell this file apart from its neighbours.",
    metadataAddField: "Add field",
    metadataKeyLabel: "Key",
    metadataValueLabel: "Value",
    metadataRemoveField: "Remove field",
    metadataNested: "nested",
    metadataNestedHint:
      "Lists and objects are edited in JSON mode, so their structure stays exactly as written.",
    metadataJsonMode: "Edit as JSON",
    metadataFieldsMode: "Fields",
    metadataInvalidJson: "That is not valid JSON.",
    metadataNotAnObject: 'Metadata must be a JSON object, like {"summary": "…"}.',
    metadataDuplicateKey: 'Two fields share the key "{key}". Keys must be unique.',
    metadataEmptyKey: "Every field needs a key.",
    metadataInvalidNumber:
      '"{key}" holds a number — enter a number, or switch to JSON mode to change its type.',
    metadataSave: "Save metadata",
    metadataSaving: "Saving metadata…",
    metadataSaved: "Metadata updated",
    metadataSaveFailed: "Could not update metadata.",
    metadataRemoveConfirmTitle: "Remove {count} field{plural}?",
    metadataRemoveConfirmBody:
      "Removing a key rewrites the whole metadata object, so anything an agent wrote while this dialog was open is lost. Edits and additions on their own merge safely; only removals rewrite.",
    metadataRemoveConfirm: "Remove and rewrite",
    metadataNoPermission:
      "You do not have write access on every place this file is used, so its metadata cannot be changed here.",
