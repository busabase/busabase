 ...
 */
export declare const iStringTrim: (str: iString) => iString;
/** True when the iString holds no non-blank text in any locale. */
export declare const iStringIsEmpty: (str: iString | null | undefined) => boolean;
/**
